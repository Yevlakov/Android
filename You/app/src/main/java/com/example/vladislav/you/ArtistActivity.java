...
public class ArtistActivity extends AppCompatActivity {
    ...
    public void MyonCheckboxClicked(View view)
    {
...

        {
            ...
            {
                mImageView.setImageDrawable(getResources().getDrawable(R.drawable.art_no));
                Toast.makeText(this, "Вы всего лишь обычный художник...", Toast.LENGTH_SHORT).show();
            }
            else
            {
                mImageView.setImageDrawable(getResources().getDrawable(R.drawable.art_yes));
                Toast.makeText(this, "Поздравляю,вы - ТЫЖхудожник!!!", Toast.LENGTH_SHORT).show();
            }
        }
