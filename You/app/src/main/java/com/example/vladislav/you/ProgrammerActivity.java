...
public class ProgrammerActivity extends AppCompatActivity
{
    ...
    public void MyonCheckboxClicked(View view)
    {
        ...
        {
            if((chb6.isChecked()||chb7.isChecked())&&!chb1.isChecked()&&!chb2.isChecked()&&!chb3.isChecked()&&!chb4.isChecked()&&!chb5.isChecked())
            {
                mImageView.setImageDrawable(getResources().getDrawable(R.drawable.prog_no));
                Toast.makeText(this, "Вы всего лишь обычный программист...", Toast.LENGTH_SHORT).show();
            }
            else
            {
                mImageView.setImageDrawable(getResources().getDrawable(R.drawable.prog_yes));
                Toast.makeText(this, "Поздравляю,вы - ТЫЖпрограммист!!!", Toast.LENGTH_SHORT).show();
            }
        }
