...
public class MusicianActivity extends AppCompatActivity {
    ...
    public void MyonCheckboxClicked(View view)
    {
...

        {
            ...
            {
                mImageView.setImageDrawable(getResources().getDrawable(R.drawable.mus_no));
                Toast.makeText(this, "Вы всего лишь обычный гитарист...", Toast.LENGTH_SHORT).show();
            }
            else
            {
                mImageView.setImageDrawable(getResources().getDrawable(R.drawable.mus_yes));
                Toast.makeText(this, "Поздравляю,вы - ТЫЖгитарист!!!", Toast.LENGTH_SHORT).show();
            }
        }
